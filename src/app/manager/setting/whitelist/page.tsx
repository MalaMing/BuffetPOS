...
export default function RegisterPage() {
    ...
    return (
        <div className="flex flex-col items-center w-full gap-10 h-screen justify-center">
        <div className="text-3xl font-bold text-primary">Employee Registration</div>
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3 w-5/6">
            ...
            <div className="flex flex-row justify-between mt-6 gap-2">
                <div className="btn" onClick={() => router.push("/manager/setting")}>Back to Setting</div>
