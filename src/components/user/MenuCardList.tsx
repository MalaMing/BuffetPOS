      ...
      {cart.length === 0 ? (
        <div className="flex justify-center items-center w-full flex-col ">
          <Icon
            ...
            fontSize={250}
            className="flex self-center text-grey w-full justify-center`"
          />
          <p className=" flex text-2xl font-bold text-center justify-center ">
            ยังไม่มีรายการอาหารในตะกร้า
          </p>
          <p className=" flex text-xl  text-center justify-center ">
            กดปุ่มเพื่อสั่งอาหารเลย
          </p>
        </div>
      ) : (
        <>
